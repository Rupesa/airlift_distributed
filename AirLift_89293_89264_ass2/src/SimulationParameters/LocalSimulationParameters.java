 ...
 */
public class LocalSimulationParameters {
     ...
     */
    public final static int REPOS_PORT = 8084;
     ...
     */
    public final static int DEPARTURE_AIRPORT_PORT = 8081;
     ...
     */
    public final static int DESTINATION_AIRPORT_PORT = 8082;
     ...
     * Plane server port.
     */
    public final static int PLANE_PORT = 8083;
    
    /**
    *   It can not be instantiated.
    */
    private LocalSimulationParameters () { }
